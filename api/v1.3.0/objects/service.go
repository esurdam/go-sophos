...
// ServiceAny represents a UTM any service
...
// ServiceGroup represents a UTM service group
...
// ServiceIcmp represents a UTM ICMPv4 service
...
// ServiceIp represents a UTM IP service
...
// ServiceTcp represents a UTM TCP service
type ServiceTcp struct {
	Locked     string `json:"_locked"`
	ObjectType string `json:"_type"`
	Reference  string `json:"_ref"`
	// AutoPfSvcDst description: REF(service/*)
	// AutoPfSvcDst default value is ""
	AutoPfSvcDst string `json:"auto_pf_svc_dst"`
	// AutoPfSvcSrc description: REF(service/*)
	// AutoPfSvcSrc default value is ""
...
// ServiceTcpudp represents a UTM TCP and UDP service
...
// ServiceUdp represents a UTM UDP service
