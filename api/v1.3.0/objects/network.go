...
// NetworkAaa represents a UTM user or group network
...
// NetworkAny represents a UTM any address
type NetworkAny struct {
	Locked     string `json:"_locked"`
	ObjectType string `json:"_type"`
	Reference  string `json:"_ref"`
	// Address can be one of: []string{"0.0.0.0"}
	// Address default value is "0.0.0.0"
	Address string `json:"address"`
	// Address6 can be one of: []string{"::"}
	...
	Resolved bool `json:"resolved"`
	// Resolved6 default value is true
	Resolved6 bool `json:"resolved6"`
}
...
// NetworkDnsGroup represents a UTM DNS group
...
// NetworkDnsHost represents a UTM DNS host
...
// NetworkGroup represents a UTM network group
...
// NetworkHost represents a UTM host
type NetworkHost struct {
	...
	// Resolved6 default value is false
	Resolved6 bool `json:"resolved6"`
	// ReverseDns default value is false
...
// NetworkInterfaceAddress represents a UTM interface address
...
// NetworkInterfaceBroadcast represents a UTM interface broadcast address
...
// NetworkInterfaceNetwork represents a UTM interface network
...
// NetworkNetwork represents a UTM network
...
// NetworkRange represents a UTM range
type NetworkRange struct {
	Locked     string `json:"_locked"`
	ObjectType string `json:"_type"`
	Reference  string `json:"_ref"`
	Comment    string `json:"comment"`
	// From description: (IPADDR)
	// From default value is ""
	From string `json:"from"`
	// From6 description: (IP6ADDR)
	// From6 default value is ""
	...
	// Resolved6 default value is false
	Resolved6 bool `json:"resolved6"`
	// To description: (IPADDR)
	// To default value is ""
	To string `json:"to"`
	// To6 description: (IP6ADDR)
	// To6 default value is ""
	To6 string `json:"to6"`
}
