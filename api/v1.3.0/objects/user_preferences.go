...
// UserPreferencesWebadmin represents a UTM WebAdmin user preferences
type UserPreferencesWebadmin struct {
	Locked     string `json:"_locked"`
	ObjectType string `json:"_type"`
	Reference  string `json:"_ref"`
	// BrowserTitle default value is "WebAdmin - User %u - Device %h"
	BrowserTitle string `json:"browser_title"`
	Comment      string `json:"comment"`
	// DashboardAutogroup default value is true
	...
	// ItemsPerPage can be one of: []string{"10", "25", "50", "100", "250", "500"}
	// ItemsPerPage default value is "10"
	ItemsPerPage string `json:"items_per_page"`
	// Language default value is "english"
	Language string `json:"language"`
	// MarketingWindow default value is false
	MarketingWindow bool   `json:"marketing_window"`
	Name            string `json:"name"`
	// Shortcuts description: (HASH)
	Shortcuts interface{} `json:"shortcuts"`
	// SkipTermsOfUse default value is false
