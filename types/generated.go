// Package sophos contains the generated Sophos types
...
// Definitions implements the Resource interface and returns a map of Nodes's RestObjects
func (Nodes) Definitions() map[string]RestObject {
	return map[string]RestObject{}
}

// GetPath implements RestObject interface and returns the Nodes GET path
...
// Definitions implements the Resource interface and returns a map of Status's RestObjects
func (Status) Definitions() map[string]RestObject {
	return map[string]RestObject{
...
// Definitions implements the Resource interface and returns a map of Aaa's RestObjects
func (Aaa) Definitions() map[string]RestObject {
	return map[string]RestObject{
		"aaa_group": AaaGroup{},
		"aaa_user":  AaaUser{},
	}
...
// GetPath implements RestObject interface and returns the AmazonVpcGroup GET path
...
// Definitions implements the Resource interface and returns a map of ApplicationControl's RestObjects
func (ApplicationControl) Definitions() map[string]RestObject {
	return map[string]RestObject{
...
// GetPath implements RestObject interface and returns the Awe GET path
...
// GetPath implements RestObject interface and returns the AweClient GET path
...
// Definitions implements the Resource interface and returns a map of AweNetworkDeviceAssociation's RestObjects
func (AweNetworkDeviceAssociation) Definitions() map[string]RestObject {
	return map[string]RestObject{
...
// Definitions implements the Resource interface and returns a map of Awscli's RestObjects
...
// GetPath implements RestObject interface and returns the Awscli GET path
func (Awscli) GetPath() string {
	return "/api/nodes/awscli"
}

// GetPath implements RestObject interface and returns the AwscliProfile GET path
func (AwscliProfile) GetPath() string {
	return "/objects/awscli/profile/"
}

// GetPath implements RestObject interface and returns the AwscliGroup GET path
...
// GetPath implements RestObject interface and returns the Ca GET path
...
// GetPath implements RestObject interface and returns the CaGroup GET path
...
// Definitions implements the Resource interface and returns a map of ClientlessVpn's RestObjects
func (ClientlessVpn) Definitions() map[string]RestObject {
	return map[string]RestObject{
...
// Definitions implements the Resource interface and returns a map of Cron's RestObjects
func (Cron) Definitions() map[string]RestObject {
	return map[string]RestObject{
		"cron_at":    CronAt{},
...
// GetPath implements RestObject interface and returns the DhcpGroup GET path
...
// GetPath implements RestObject interface and returns the DnsAxfr GET path
...
// GetPath implements RestObject interface and returns the Dyndns GET path
...
// GetPath implements RestObject interface and returns the EmailpkiUser GET path
func (EmailpkiUser) GetPath() string {
	return "/objects/emailpki/user/"
}

// GetPath implements RestObject interface and returns the EmailpkiGroup GET path
...
// GetPath implements RestObject interface and returns the Epp GET path
...
// GetPath implements RestObject interface and returns the Ftp GET path
...
// GetPath implements RestObject interface and returns the GeoipDstexception GET path
...
// GetPath implements RestObject interface and returns the Hotspot GET path
...
// GetPath implements RestObject interface and returns the Http GET path
...
// GetPath implements RestObject interface and returns the HttpPacFile GET path
...
// Definitions implements the Resource interface and returns a map of IpfixConnection's RestObjects
func (IpfixConnection) Definitions() map[string]RestObject {
	return map[string]RestObject{
...
// GetPath implements RestObject interface and returns the IpsRuleModifier GET path
...
// GetPath implements RestObject interface and returns the IpsecPolicy GET path
...
// Definitions implements the Resource interface and returns a map of Packetfilter's RestObjects
...
// GetPath implements RestObject interface and returns the Packetfilter GET path
...
// GetPath implements RestObject interface and returns the PacketfilterMangle GET path
...
// GetPath implements RestObject interface and returns the PacketfilterRuleset GET path
...
// GetPath implements RestObject interface and returns the PacketfilterLoadbalance GET path
...
// GetPath implements RestObject interface and returns the PimSmInterface GET path
...
// GetPath implements RestObject interface and returns the Pop3 GET path
...
// GetPath implements RestObject interface and returns the Qos GET path
...
// GetPath implements RestObject interface and returns the QosTrafficSelectorGroup GET path
...
// GetPath implements RestObject interface and returns the RemoteSyslog GET path
...
// GetPath implements RestObject interface and returns the Reporting GET path
...
// GetPath implements RestObject interface and returns the ReportingMail GET path
...
// GetPath implements RestObject interface and returns the ReverseProxy GET path
...
// GetPath implements RestObject interface and returns the ReverseProxyProfile GET path
...
// GetPath implements RestObject interface and returns the ReverseProxyFormTemplate GET path
...
// Definitions implements the Resource interface and returns a map of Right's RestObjects
func (Right) Definitions() map[string]RestObject {
	return map[string]RestObject{
...
// Definitions implements the Resource interface and returns a map of Role's RestObjects
func (Role) Definitions() map[string]RestObject {
	return map[string]RestObject{
		"role_role":  RoleRole{},
...
// GetPath implements RestObject interface and returns the SmtpProfile GET path
func (SmtpProfile) GetPath() string {
	return "/objects/smtp/profile/"
}

// GetPath implements RestObject interface and returns the SmtpHeaderOperation GET path
...
// GetPath implements RestObject interface and returns the Snmp GET path
...
// Definitions implements the Resource interface and returns a map of Spx's RestObjects
...
// GetPath implements RestObject interface and returns the Spx GET path
func (Spx) GetPath() string {
	return "/api/nodes/spx"
}

// GetPath implements RestObject interface and returns the SpxGroup GET path
func (SpxGroup) GetPath() string {
	return "/objects/spx/group/"
}

// GetPath implements RestObject interface and returns the SpxTemplate GET path
...
// Definitions implements the Resource interface and returns a map of SslVpn's RestObjects
...
// GetPath implements RestObject interface and returns the SslVpn GET path
func (SslVpn) GetPath() string {
	return "/api/nodes/ssl_vpn"
}

// GetPath implements RestObject interface and returns the SslVpnServerConnection GET path
func (SslVpnServerConnection) GetPath() string {
	return "/objects/ssl_vpn/server_connection/"
}

// GetPath implements RestObject interface and returns the SslVpnClientConnection GET path
func (SslVpnClientConnection) GetPath() string {
	return "/objects/ssl_vpn/client_connection/"
}

// GetPath implements RestObject interface and returns the SslVpnGroup GET path
func (SslVpnGroup) GetPath() string {
	return "/objects/ssl_vpn/group/"
}

// GetPath implements RestObject interface and returns the SslVpnRemoteAccessProfile GET path
...
// Definitions implements the Resource interface and returns a map of UserPreferences's RestObjects
func (UserPreferences) Definitions() map[string]RestObject {
	return map[string]RestObject{
