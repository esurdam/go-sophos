...
var defNodes = &sophos.Definition{Description: "Nodes", Name: "Nodes", Link: "/api/definitions/nodes", Swag: map[string]sophos.MethodMap{"/nodes/": {"get": sophos.MethodDescriptions{Description: "Returns all available nodes", Parameters: []sophos.Parameter(nil), Tags: []string{"Multiple Nodes"}, Responses: map[int]struct{ Description string }{200: {Description: "OK"}, 401: {Description: "Unauthorized"}, 403: {Description: "Forbidden to change/read the node (rights/role not sufficient)"}}}, "patch": sophos.MethodDescriptions{Description: "Change multiple nodes at once", Parameters: []sophos.Parameter{{Name: "body", In: "body", Description: "Subset or complete result of GET /nodes", Type: "", Required: true}}, Tags: []string{"Multiple Nodes"}, Responses: map[int]struct{ Description string }{403: {Description: "Forbidden to change/read the node (rights/role not sufficient)"}, 200: {Description: "OK"}, 401: {Description: "Unauthorized"}}}}, "/nodes/{id}": {"get": sophos.MethodDescriptions{Description: "Returns one specific node", Parameters: []sophos.Parameter{{Name: "id", In: "path", Description: "id of the node", Type: "string", Required: true}}, Tags: []string{"Single Nodes"}, Responses: map[int]struct{ Description string }{401: {Description: "Unauthorized"}, 403: {Description: "Forbidden to change/read the node (rights/role not sufficient)"}, 404: {Description: "Node not found"}, 204: {Description: "OK"}, 400: {Description: "Bad update request, checkout the error message for details"}}}, "put": sophos.MethodDescriptions{Description: "Update one specific node", Parameters: []sophos.Parameter{{Name: "id", In: "path", Description: "id of the node", Type: "string", Required: true}, {Name: "body", In: "body", Description: "New value of the node", Type: "", Required: true}}, Tags: []string{"Single Nodes"}, Responses: map[int]struct{ Description string }{204: {Description: "OK"}, 400: {Description: "Bad update request, checkout the error message for details"}, 401: {Description: "Unauthorized"}, 403: {Description: "Forbidden to change/read the node (rights/role not sufficient)"}, 404: {Description: "Node not found"}}}}}}
