...
var funcTemp = `
// Definitions implements the Resource interface and returns {{.Title}}'s RestObjects
...
// GetPath implements RestObject and returns the {{.Title}} GET path
...
// ApiRoutes returns all known paths {{.Title}} paths
func({{.Title}}) ApiRoutes() []string{
	return []string{
		{{range $i, $element := .Routes}}"{{$element}}",
		{{end}}
	}
}`
...
var subTypeTemplate = `
// {{.Title}} is a generated struct representing the Sophos {{.Name}} Node Object
// GET {{.Path}}
type {{.Title}} struct {
...
func main() {
	...
	f, err := os.Create(os.Getenv("GOPATH") + "/src/github.com/esurdam/go-sophos/generated.go")
	if err != nil {
		log.Fatal(err)
	}
	...
	f.Write([]byte(`// This file was generated by bin/gen.go! DO NOT EDIT!
package sophos
