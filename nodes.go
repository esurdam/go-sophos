...
// Nodes are resources within Sophos UTM that you can update but cannot create, delete, or move.
...
// Objects reside in collections, which you can create, change, or delete. The collections of objects are
...
// References are the connections between nodes and objects as well as between one object and another object.
